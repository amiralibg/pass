...
export const STARTER_PACKS: StarterPack[] = [
  ...
  },
  {
    id: 'afterdark',
    starters: [
      { id: 'ad1', text: { en: 'The hotel only had one bed left, and…', fa: 'هتل فقط یک تخت خالی داشت، و…' } },
      { id: 'ad2', text: { en: 'The text said “come over, they’re asleep,” so…', fa: 'پیام نوشته بود «بیا، خوابن»، پس…' } },
      { id: 'ad3', text: { en: 'Truth or dare had gone way too far when…', fa: 'جرئت یا حقیقت وقتی خیلی از حدش گذشت که…' } },
      { id: 'ad4', text: { en: 'She locked the door and turned around slowly…', fa: 'در را قفل کرد و آرام برگشت…' } },
      { id: 'ad5', text: { en: 'The dating app match knocked exactly on time…', fa: 'مچِ اپ دوستیابی دقیقاً سر وقت در زد…' } },
      { id: 'ad6', text: { en: 'Nobody was supposed to find the photos, but…', fa: 'قرار نبود کسی عکس‌ها را پیدا کند، اما…' } },
      { id: 'ad7', text: { en: 'The honeymoon suite came with a note that said…', fa: 'سوئیت ماه‌عسل یک یادداشت داشت که نوشته بود…' } },
      { id: 'ad8', text: { en: 'One more glass of wine and the confession slipped out…', fa: 'یک لیوان شراب دیگر و اعتراف از دهانش پرید…' } },
      { id: 'ad9', text: { en: 'The neighbors banged on the wall because…', fa: 'همسایه‌ها به دیوار کوبیدند چون…' } },
      { id: 'ad10', text: { en: 'He whispered a dare I couldn’t say no to…', fa: 'یک جرئت در گوشم گفت که نتوانستم نه بگویم…' } },
      { id: 'ad11', text: { en: 'The bachelorette party took a turn when the stripper…', fa: 'مهمانی مجردی وقتی رقصنده…' } },
      { id: 'ad12', text: { en: 'We matched, we met, and by midnight…', fa: 'مچ شدیم، دیدار کردیم، و تا نیمه‌شب…' } },
      { id: 'ad13', text: { en: 'The lock screen lit up with a name I shouldn’t know…', fa: 'صفحهٔ قفل با اسمی روشن شد که نباید می‌دانستم…' } },
      { id: 'ad14', text: { en: 'The massage was supposed to be professional until…', fa: 'ماساژ قرار بود کاملاً حرفه‌ای باشد تا اینکه…' } },
      { id: 'ad15', text: { en: 'Two exes, one hot tub, and no witnesses…', fa: 'دو تا اکس، یک جکوزی، و هیچ شاهدی…' } },
      { id: 'ad16', text: { en: 'The safe word turned out to be…', fa: 'کلمهٔ امن آخرش شد…' } },
      { id: 'ad17', text: { en: 'She left her number written on my…', fa: 'شماره‌اش را روی … من نوشت…' } },
      { id: 'ad18', text: { en: 'The group chat screenshot ended three relationships when…', fa: 'اسکرین‌شات گروه‌چت سه رابطه را وقتی به هم زد که…' } },
      { id: 'ad19', text: { en: 'Room service arrived at the worst possible moment…', fa: 'سرویس اتاق در بدترین لحظهٔ ممکن رسید…' } },
      { id: 'ad20', text: { en: 'The last thing I remember is the karaoke bar and…', fa: 'آخرین چیزی که یادم است بار کارائوکه بود و…' } },
      { id: 'ad21', text: { en: 'We swore it was a one-time thing, but then…', fa: 'قسم خوردیم فقط یک بار است، اما بعد…' } },
      { id: 'ad22', text: { en: 'The Uber driver definitely heard everything when…', fa: 'رانندهٔ اسنپ قطعاً همه‌چیز را شنید وقتی…' } },
      { id: 'ad23', text: { en: 'His ex showed up at the wedding and…', fa: 'اکسش سر عروسی پیدایش شد و…' } },
      { id: 'ad24', text: { en: 'The blindfold came off and standing there was…', fa: 'چشم‌بند که برداشته شد، آنجا … ایستاده بود…' } },
      { id: 'ad25', text: { en: 'It started as a game of strip poker and ended with…', fa: 'با یک دست پوکر لباسی شروع شد و با … تمام شد…' } },
      { id: 'ad26', text: { en: 'The morning after, I found a note that read…', fa: 'صبح روز بعد، یادداشتی پیدا کردم که نوشته بود…' } },
      { id: 'ad27', text: { en: 'She dared me to text my crush, so I…', fa: 'جرئتم داد به کراشم پیام بدهم، پس…' } },
      { id: 'ad28', text: { en: 'The pool party got wild the second the lights dimmed…', fa: 'مهمانی استخر همان لحظه که چراغ‌ها کم شد وحشی شد…' } },
      { id: 'ad29', text: { en: 'Nobody expected the couples’ retreat to end in…', fa: 'هیچ‌کس انتظار نداشت اردوی زوج‌ها به … ختم شود…' } },
      { id: 'ad30', text: { en: 'The last text before my phone died was…', fa: 'آخرین پیام قبل از خاموش‌شدن گوشی‌ام این بود…' } },
    ],
  },
]
